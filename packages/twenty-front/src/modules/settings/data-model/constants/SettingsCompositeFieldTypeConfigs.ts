    ...
    exampleValues: [
      {
        ...
        primaryLinkLabel: '',
        secondaryLinks: JSON.stringify([{ url: 'twenty.com', label: 'Twenty' }]) as any,
      },
      {
        primaryLinkUrl: 'github.com/twentyhq/twenty',
        primaryLinkLabel: 'Twenty Repo',
        secondaryLinks: JSON.stringify([{ url: 'twenty.com', label: '' }]) as any,
      },
      {
        primaryLinkUrl: 'react.dev',
        primaryLinkLabel: '',
        secondaryLinks: JSON.stringify([]) as any,
      },
    ],
    category: 'Basic',
    ...
    exampleValues: [
      {
        ...
        context: JSON.stringify({ provider: ConnectedAccountProvider.GOOGLE }) as any,
      },
      {
        source: 'MANUAL',
        name: 'name',
        workspaceMemberId: 'id',
        context: JSON.stringify({ provider: ConnectedAccountProvider.MICROSOFT }) as any,
      },
      {
        source: 'WEBHOOK',
        name: 'name',
        workspaceMemberId: 'id',
        context: JSON.stringify({}) as any,
      },
    ],
