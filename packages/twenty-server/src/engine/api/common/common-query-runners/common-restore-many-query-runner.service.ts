...
> {
  ...
  async run(
    ...
    // Get count of records that will be affected BEFORE the restore
    ...
    await this.metricsService.incrementCounter({
      key: MetricsKeys.CommonRestoreMany,
    });
    ...
    await this.metricsService.incrementCounter({
      key: MetricsKeys.CommonRestoreManyRecordsAffected,
      attributes: {
        recordCount: restoredRecords.length,
